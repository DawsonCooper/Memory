import React, {useEffect, useState}/*, { useState, useContext }*/ from 'react';
...
export default function MineSweeperMain(props){
    ...
    return(
        ...
        <div>
            <button id='reset-button' onClick={generateBoard}>Reset</button>
        </div>
        
        <div id='game-container'>
            <MinesweeperBoard gameCells={gameBoard}/>
        </div>
